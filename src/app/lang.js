...
export const translations = {
  jp: {
    ...
    ariTitle: "Ari",
    ariDesc:
      "シンプルな UI とスムーズな操作感を重視した赤ちゃんのログアプリ。プライバシーに配慮した設計で、日々の記録をサクサク残せます。",
    mojiTitle: "Moji Day",
    mojiDesc:
      "カレンダー型のトラッカーアプリ。必要な機能だけに絞り、視認性と軽快さを重視したデザインで毎日の記録をサポートします。",
    clientAppsTitle: "クライアントアプリ",
    clientAppsDesc:
      "React Native を用いて、国内の大規模アプリの機能実装や UI/UX 改善を担当し、iOS・Android 双方で快適に使える体験づくりに取り組んでいます。",
    project1Title: "サイトリニューアル",
    project1Desc:
      "PMとして2件の大規模サイトリニューアルを担当。構造もサーバー環境も異なる2サイトをゼロから再構築し、設計から公開までを主導。（使用技術：WordPress／PHP／HTML／CSS／JavaScript／Kinsta／MySQL（MariaDB）／HubSpot（フォーム・チャットボット機能のみ）／AWS（CloudFront Functions・Route 53））",
    project2Title: "HP制作",
    project2Desc:
      "地方自治体から小規模企業まで、5年以上にわたり個人クライアント向けにサイト制作から保守管理までを一貫して担当（使用技術：HTML／CSS／JavaScript／React／TypeScript／Next.js）",
  ...
  en: {
    aboutTitle: "McK",
    aboutText:
      "Bilingual Mobile/Web Developer based in Tokyo, Japan. I like computer stuff.",
    ...
    ariTitle: "Ari",
    ariDesc:
      "A baby-tracking app with a clean UI, smooth interactions, and privacy-first design to make daily logging quick and stress-free.",
    mojiTitle: "Moji Day",
    mojiDesc:
      "A calendar-based tracker that focuses on clarity and speed, with just the essentials so you can log daily entries without friction.",
    clientAppsTitle: "Client Apps",
    clientAppsDesc:
      "I work on several major Japanese mobile apps built with React Native, handling feature implementation and UI/UX improvements to keep the apps smooth and intuitive across iOS and Android.",
    project1Title: "Large-Scale Site Renewals",
    project1Desc:
      "Led two major website renewals for a high-profile SaaS company. Rebuilt both sites from scratch with different structures and server setups, managing everything from planning to launch (Tech stack: WordPress, PHP, HTML, CSS, JavaScript, Kinsta, MySQL (MariaDB), HubSpot (forms & chatbot), AWS (CloudFront Functions, Route 53))",
    project2Title: "Web Development",
    project2Desc:
      "5+ years of freelance website creation to ongoing maintenance for individual clients ranging from local governments to small businesses (Tech stack: HTML, CSS, JavaScript, React, TypeScript, Next.js)",
